...
def get_road_segment_connections(road_indices,row_num,col_num):
	...
	road_segment_connections.transpose()

	return road_segment_connectionsd

def get_road_segment_counts(roads,road_indices,sim_dict,dt=.1):
