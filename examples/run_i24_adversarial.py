...
def get_flow_params(attack_duration,attack_magnitude,acc_penetration,inflow,emission_path):
...
def run_attack_sim(attack_duration,attack_magnitude,acc_penetration,inflow,emission_path,rename_file,get_results=True,delete_file=False):

	flow_params = get_flow_params(attack_duration,attack_magnitude,acc_penetration,inflow,emission_path)
	...
	if(rename_file):
		...
		file_name_no_version = 'Dur_'+str(attack_duration)+'_Mag_'+str(attack_magnitude)+'_Inflow_'+str(inflow)+'_Penetration_'+str(acc_penetration)
...
@ray.remote
def run_attack_sim_ray(attack_duration,attack_magnitude,acc_penetration,inflow,emission_path,rename_file,get_results=True,delete_file=False):
				...
				for acc_penetration in acc_penetration_list:
					try:
						if(want_parallel):
							...
							sim_results = run_attack_sim(attack_duration,attack_magnitude,acc_penetration,inflow,emission_path,rename_file)
