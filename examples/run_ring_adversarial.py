...
def get_flow_params(attack_duration,
	...
	WARMUP_STEPS = 200 #Attack vehicles don't attack before this # of steps
	...
	# num_human_drivers = 99
	# num_attack_acc_drivers = 1	
	# num_benign_acc_drivers = 0
...
if __name__ == "__main__":
	emission_path = '/Users/vanderbilt/Desktop/Research_2020/Traffic_Attack/flow/examples/ringroad_adversarial_sims'
	ring_length = 1800
	acc_penetration = 0.2
